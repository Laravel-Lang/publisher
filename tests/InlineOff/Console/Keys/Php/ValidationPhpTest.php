...
class ValidationPhpTest extends BasePhpTestCase
{
    ...
    protected $items = [
        ...
        'between.numeric'   => ['The :attribute must be between :min and :max.', 'Поле :attribute должно быть между :min и :max.'],
        ...
        'gt.numeric'        => ['The :attribute must be greater than :value.', 'Поле :attribute должно быть больше :value.'],
        ...
        'gte.numeric'       => ['The :attribute must be greater than or equal to :value.', 'Поле :attribute должно быть :value или больше.'],
        ...
        'lt.numeric'        => ['The :attribute must be less than :value.', 'Поле :attribute должно быть меньше :value.'],
        ...
        'lte.numeric'       => ['The :attribute must be less than or equal to :value.', 'Поле :attribute должно быть :value или меньше.'],
        ...
        'max.numeric'       => ['The :attribute may not be greater than :max.', 'Поле :attribute не может быть больше :max.'],
        ...
        'min.numeric'       => ['The :attribute must be at least :min.', 'Поле :attribute должно быть не меньше :min.'],
        ...
        'size.numeric'      => ['The :attribute must be :size.', 'Поле :attribute должно быть равным :size.'],
