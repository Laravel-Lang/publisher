...
class ValidationPhpTest extends BasePhpTestCase
{
    ...
    protected $items = [
        ...
        'between.numeric'   => ['The :attribute must be between :min and :max.', 'Количество элементов в поле :attribute должно быть между :min и :max.'],
        ...
        'between.string'    => ['The :attribute must be between :min and :max characters.', 'Поле :attribute должно быть между :min и :max.'],
        'between.array'     => ['The :attribute must have between :min and :max items.', 'Количество символов в поле :attribute должно быть между :min и :max.'],
        ...
        'gt.numeric'        => ['The :attribute must be greater than :value.', 'Количество элементов в поле :attribute должно быть больше :value.'],
        ...
        'gt.string'         => ['The :attribute must be greater than :value characters.', 'Поле :attribute должно быть больше :value.'],
        'gt.array'          => ['The :attribute must have more than :value items.', 'Количество символов в поле :attribute должно быть больше :value.'],
        'gte.numeric'       => ['The :attribute must be greater than or equal :value.', 'Количество элементов в поле :attribute должно быть :value или больше.'],
        'gte.file'          => ['The :attribute must be greater than or equal :value kilobytes.', 'Размер файла в поле :attribute должен быть :value Килобайт(а) или больше.'],
        'gte.string'        => ['The :attribute must be greater than or equal :value characters.', 'Поле :attribute должно быть :value или больше.'],
        'gte.array'         => ['The :attribute must have :value items or more.', 'Количество символов в поле :attribute должно быть :value или больше.'],
        ...
        'lt.numeric'        => ['The :attribute must be less than :value.', 'Количество элементов в поле :attribute должно быть меньше :value.'],
        ...
        'lt.string'         => ['The :attribute must be less than :value characters.', 'Поле :attribute должно быть меньше :value.'],
        'lt.array'          => ['The :attribute must have less than :value items.', 'Количество символов в поле :attribute должно быть меньше :value.'],
        'lte.numeric'       => ['The :attribute must be less than or equal :value.', 'Количество элементов в поле :attribute должно быть :value или меньше.'],
        'lte.file'          => ['The :attribute must be less than or equal :value kilobytes.', 'Размер файла в поле :attribute должен быть :value Килобайт(а) или меньше.'],
        'lte.string'        => ['The :attribute must be less than or equal :value characters.', 'Поле :attribute должно быть :value или меньше.'],
        'lte.array'         => ['The :attribute must not have more than :value items.', 'Количество символов в поле :attribute должно быть :value или меньше.'],
        'max.numeric'       => ['The :attribute may not be greater than :max.', 'Количество элементов в поле :attribute не может превышать :max.'],
        ...
        'max.string'        => ['The :attribute may not be greater than :max characters.', 'Поле :attribute не может быть больше :max.'],
        'max.array'         => ['The :attribute may not have more than :max items.', 'Количество символов в поле :attribute не может превышать :max.'],
        ...
        'min.numeric'       => ['The :attribute must be at least :min.', 'Количество элементов в поле :attribute должно быть не меньше :min.'],
        'min.file'          => ['The :attribute must be at least :min kilobytes.', 'Размер файла в поле :attribute должен быть не меньше :min Килобайт(а).'],
        'min.string'        => ['The :attribute must be at least :min characters.', 'Поле :attribute должно быть не меньше :min.'],
        'min.array'         => ['The :attribute must have at least :min items.', 'Количество символов в поле :attribute должно быть не меньше :min.'],
        ...
        'regex'             => ['The :attribute format is invalid.', 'Поле :attribute запрещено.'],
        'relatable'         => ['This :attribute may not be associated with this resource.', 'Поле :attribute запрещено, когда :other равно :value.'],
        'required'          => ['The :attribute field is required.', 'Поле :attribute запрещено, если :other не входит в :values.'],
        'required_if'       => ['The :attribute field is required when :other is :value.', 'Поле :attribute запрещает присутствие :other.'],
        'required_unless'   => ['The :attribute field is required unless :other is in :values.', 'Поле :attribute имеет ошибочный формат.'],
        'required_with'     => ['The :attribute field is required when :values is present.', 'Поле :attribute не может быть связано с этим ресурсом.'],
        'required_with_all' => ['The :attribute field is required when :values are present.', 'Поле :attribute обязательно для заполнения.'],
        'required_without'  => ['The :attribute field is required when :values is not present.', 'Поле :attribute обязательно для заполнения, когда :other равно :value.'],
        ...
        'prohibited'        => ['The :attribute field is prohibited.', 'Поле :attribute обязательно для заполнения, когда :values указано.'],
        'prohibited_if'     => ['The :attribute field is prohibited when :other is :value.', 'Поле :attribute обязательно для заполнения, когда :values указано.'],
        'prohibited_unless' => ['The :attribute field is prohibited unless :other is in :values.', 'Поле :attribute обязательно для заполнения, когда :values не указано.'],
        'prohibits'         => ['The :attribute field prohibits :other from being present.', 'Поле :attribute обязательно для заполнения, когда ни одно из :values не указано.'],
        'same'              => ['The :attribute and :other must match.', 'Значения полей :attribute и :other должны совпадать.'],
        'size.numeric'      => ['The :attribute must be :size.', 'Количество элементов в поле :attribute должно быть равным :size.'],
        'size.file'         => ['The :attribute must be :size kilobytes.', 'Размер файла в поле :attribute должен быть равен :size Килобайт(а).'],
        'size.string'       => ['The :attribute must be :size characters.', 'Поле :attribute должно быть равным :size.'],
        'size.array'        => ['The :attribute must contain :size items.', 'Количество символов в поле :attribute должно быть равным :size.'],
