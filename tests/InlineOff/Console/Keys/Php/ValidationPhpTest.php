...
class ValidationPhpTest extends BasePhpTestCase
{
    ...
    protected $items = [
        ...
        'alpha'          => ['The :attribute must only contain letters.', 'Поле :attribute может содержать только буквы.'],
        ...
        'max.array'         => ['The :attribute must not have more than :max items.', 'Количество элементов в поле :attribute не может превышать :max.'],
        'max.file'          => ['The :attribute must not be greater than :max kilobytes.', 'Размер файла в поле :attribute не может быть больше :max Килобайт(а).'],
        'max.numeric'       => ['The :attribute must not be greater than :max.', 'Значение поля :attribute не может быть больше :max.'],
        'max.string'        => ['The :attribute must not be greater than :max characters.', 'Количество символов в поле :attribute не может превышать :max.'],
