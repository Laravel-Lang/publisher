...
class ValidationPhpTest extends BasePhpTestCase
{
    ...
    protected $items = [
        ...
        'max.array'            => ['The content may not have more than :max items.', 'Количество элементов не может превышать :max.'],
        'max.file'             => ['The file size may not be greater than :max kilobytes.', 'Размер файла не может быть больше :max Килобайт(а).'],
        'max.numeric'          => ['The value may not be greater than :max.', 'Значение не может быть больше :max.'],
        'max.string'           => ['The string may not be greater than :max characters.', 'Количество символов не может превышать :max.'],
        ...
        'relatable'            => ['This field may not be associated with this resource.', 'Объект не может быть связан с этим ресурсом.'],
