...
class ValidationPhpTest extends BasePhpTestCase
{
    ...
    protected $items = [
        ...
        'alpha_dash'           => ['This field must only contain letters, numbers, dashes and underscores.', 'Здесь могут быть только буквы, цифры, дефис и нижнее подчеркивание.'],
        ...
        'gt.array'             => ['The content must have more than :value items.', 'Количество элементов должно быть больше :value.'],
        'gt.file'              => ['The file size must be greater than :value kilobytes.', 'Размер файла должен быть больше :value Килобайт(а).'],
        'gt.numeric'           => ['The value must be greater than :value.', 'Значение должно быть больше :value.'],
        'gt.string'            => ['The string must be greater than :value characters.', 'Количество символов должно быть больше :value.'],
        'gte.array'            => ['The content must have :value items or more.', 'Количество элементов должно быть :value или больше.'],
        'gte.file'             => ['The file size must be greater than or equal to :value kilobytes.', 'Размер файла должен быть :value Килобайт(а) или больше.'],
        'gte.numeric'          => ['The value must be greater than or equal to :value.', 'Значение должно быть :value или больше.'],
        'gte.string'           => ['The string must be greater than or equal to :value characters.', 'Количество символов должно быть :value или больше.'],
        ...
        'lt.array'             => ['The content must have less than :value items.', 'Количество элементов должно быть меньше :value.'],
        'lt.file'              => ['The file size must be less than :value kilobytes.', 'Размер файла должен быть меньше :value Килобайт(а).'],
        'lt.numeric'           => ['The value must be less than :value.', 'Значение должно быть меньше :value.'],
        'lt.string'            => ['The string must be less than :value characters.', 'Количество символов должно быть меньше :value.'],
        'lte.array'            => ['The content must not have more than :value items.', 'Количество элементов должно быть :value или меньше.'],
        'lte.file'             => ['The file size must be less than or equal to :value kilobytes.', 'Размер файла должен быть :value Килобайт(а) или меньше.'],
        'lte.numeric'          => ['The value must be less than or equal to :value.', 'Значение должно быть :value или меньше.'],
        'lte.string'           => ['The string must be less than or equal to :value characters.', 'Количество символов должно быть :value или меньше.'],
        'max.array'            => ['The content must not have more than :max items.', 'Количество элементов не может превышать :max.'],
        'max.file'             => ['The file size must not be greater than :max kilobytes.', 'Размер файла не может быть больше :max Килобайт(а).'],
        'max.numeric'          => ['The value must not be greater than :max.', 'Значение не может быть больше :max.'],
        'max.string'           => ['The string must not be greater than :max characters.', 'Количество символов не может превышать :max.'],
        ...
        'min.array'            => ['The value must have at least :min items.', 'Количество элементов должно быть не меньше :min.'],
        'min.file'             => ['The file size must be at least :min kilobytes.', 'Размер файла должен быть не меньше :min Килобайт(а).'],
        'min.numeric'          => ['The value must be at least :min.', 'Значение должно быть не меньше :min.'],
        'min.string'           => ['The string must be at least :min characters.', 'Количество символов должно быть не меньше :min.'],
        ...
        'prohibited'           => ['This field is prohibited.', 'Данное значение запрещено.'],
        'prohibited_if'        => ['This field is prohibited when :other is :value.', 'Значение запрещено, когда :other равно :value.'],
        'prohibited_unless'    => ['This field is prohibited unless :other is in :values.', 'Значение запрещено, если :other не входит в :values.'],
        'prohibits'            => ['This field prohibits :other from being present.', 'Запрещено присутствие :other.'],
        'regex'                => ['This format is invalid.', 'Ошибочный формат.'],
        'required'             => ['This field is required.', 'Обязательно для заполнения.'],
        'required_if'          => ['This field is required when :other is :value.', 'Обязательно для заполнения, когда :other равно :value.'],
        'required_unless'      => ['This field is required unless :other is in :values.', 'Обязательно для заполнения, когда :other не равно :values.'],
        'required_with'        => ['This field is required when :values is present.', 'Обязательно для заполнения, когда :values указано.'],
        'required_with_all'    => ['This field is required when :values are present.', 'Обязательно для заполнения, когда :values указано.'],
        'required_without'     => ['This field is required when :values is not present.', 'Обязательно для заполнения, когда :values не указано.'],
        'required_without_all' => ['This field is required when none of :values are present.', 'Обязательно для заполнения, когда ни одно из :values не указано.'],
        'same'                 => ['The value of this field must match the one from :other.', 'Значение должно совпадать с :other.'],
        'size.array'           => ['The content must contain :size items.', 'Количество элементов должно быть равным :size.'],
        'size.file'            => ['The file size must be :size kilobytes.', 'Размер файла должен быть равен :size Килобайт(а).'],
        'size.numeric'         => ['The value must be :size.', 'Значение должно быть равным :size.'],
        'size.string'          => ['The string must be :size characters.', 'Количество символов должно быть равным :size.'],
