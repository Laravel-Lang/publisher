...
|7.x|^7.2.5|7.2, 7.3, 7.4|^4.0|4.0.0|^4.0| ![Supported][badge_supported] To fix config cache errors on production, update the `case` key value in [config/lang-publisher.php](config/lang-publisher.php#L43) file.|
