...
|5.5|^7.0.0|7.1|^1.0|1.0.0|1.6.0|---|
|5.6|^7.1.3|7.2|^1.0|1.0.0|1.6.0|---|
|5.7, 5.8|^7.1.3|7.2|^1.0|1.0.0|1.6.0|You can install package `^1.0` version on the Laravel 5.8, but there are two nuances: translation files from version 5.7 will be copied, and there will be no support for [saving validator keys](https://github.com/andrey-helldar/laravel-lang-publisher#features).|
